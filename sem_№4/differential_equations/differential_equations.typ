...
#proof[\
    ...
    $(3)==>(1)$ \ 
    Фиксируем $epsilon>0$, пусть $x_0: space |y_0-x_0|<delta$. Тогда $|y_k-x_k| = |Phi_k (y_0-x_0)| < ||Phi_k|| delta = M delta$, выберем $delta = epsilon/M, space $ получим $M delta< epsilon$ а значит $|y_k-x_k| --> 0$.
]

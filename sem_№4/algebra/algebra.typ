...
#proof[
    ...
    $
    Имеем равенство того что стоит в ячейках $(i,k)$ в $H(phi) H(psi)$ и $H(phi compose psi)$, изоморфность является очевидной и оставляется как упражнение читателю (ZZZZZZZZ GOIDA) 
]
